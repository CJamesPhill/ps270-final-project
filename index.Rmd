...
```{r}
presappplot <- ggplot(data = presapp, mapping = aes(x = approval, y = year)) +
  geom_point() +
  labs(x = "Presidential Approval Rating (%)",
       y = "Year",
