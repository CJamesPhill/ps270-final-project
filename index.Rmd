...
description: "The relationship between yearly inflation and presidential approval ratings."
output:
...
knitr::kable(
    digits = 2,
    col.names = c("President", "Year", "Approval Rating (%)", "Approval Rating"),
    caption = "Presidential Approval Ratings Data Preview"
  )
...
inflation |>
  ...
  knitr::kable(
    digits = 2,
    col.names = c("Observation Date", "Inflation", "Year"),
    caption = "Inflation Data Preview"
  )
```

### **Visualizing Presidential Voting Records**
...
### **Relationship Between Inflation and Presidential Approval Ratings**
